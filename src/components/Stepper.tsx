...
export default function Stepper({
  ...
  useEffect(() => {
    if (typeof controlledStep !== 'number') return;
    if (controlledStep < 1 || controlledStep > totalSteps) return;
    if (controlledStep === currentStep) return;

    setDirection(controlledStep > currentStep ? 1 : -1);
    setCurrentStep(controlledStep);
  }, [controlledStep, currentStep, totalSteps]);
